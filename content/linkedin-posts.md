# LinkedIn Post Templates for krmaazha

## Post 1: The Hook (Use This First — High Engagement)

I reviewed 47 resumes last month.

73% failed the ATS screen before a human ever opened them.
...
ChatGPT can not tailor your resume properly.
...
## Post 3: The Social Proof / Story Post

"I sent 200 resumes and got 3 callbacks."

That is what a client told me before we worked together.

After running their resume through the 5-agent system for 5 targeted roles, they got 4 interviews in 2 weeks.
...
## Post 4: The Quick Value Post (Short, High Shareability)

3 signs your resume is failing ATS:
...
## Post 5: The Personal Story / Authority Builder

I spent 5 years in data engineering and AI. I watched smart people get rejected by software before a person ever judged them.
...
1. **Copy any post** above and paste into LinkedIn
2. **Replace** `krmaazha@gmail.com` with your email if it ever changes
3. **Rotate hashtags** — never use the same set twice in a row
4. **Post 2-3x per week** for algorithm reach
5. **Engage for 15 min after posting** — reply to every comment in the first hour
6. **Tag 2-3 people** in comments (not the post) to trigger notifications
...
## Pro Tips for LinkedIn Algorithm

- **First line is everything** — make it a pattern interrupt
- **Use line breaks** — walls of text get skipped
- **No external links in the post** — put them in the first comment instead (algorithm punishes link posts)
- **Post between 8-10 AM or 12-2 PM** in your target timezone (US Eastern for tech jobs)
- **Reply to every comment within 1 hour** — this signals engagement to the algorithm
- **Do not edit the post after publishing** — algorithm resets reach on edits
